...
def interpret_expression(expression: str) -> LiteralValue:
...
class TestInterpreterBasicExpressions(unittest.TestCase):
    def test_equality_equal_true(self) -> None:
        self.assertEqual(interpret_expression("3==3"), True)

    def test_equality_equal_false(self) -> None:
        self.assertEqual(interpret_expression("1==3"), False)

    def test_equality_not_equal_true(self) -> None:
        self.assertEqual(interpret_expression("1!=3"), True)

    def test_equality_not_equal_false(self) -> None:
        self.assertEqual(interpret_expression("3!=3"), False)

    def test_comparison_greater_than_true(self) -> None:
        self.assertEqual(interpret_expression("3>2"), True)

    def test_comparison_greater_than_false(self) -> None:
        self.assertEqual(interpret_expression("2>2"), False)

    def test_comparison_greater_than_or_equal_true(self) -> None:
        self.assertEqual(interpret_expression("2>=2"), True)

    def test_comparison_greater_than_or_equal_false(self) -> None:
        self.assertEqual(interpret_expression("2>=3"), False)

    def test_comparison_lesser_than_true(self) -> None:
        self.assertEqual(interpret_expression("2<3"), True)
    ...
    def test_comparison_lesser_than_or_equal_false(self) -> None:
        self.assertEqual(interpret_expression("3<=2"), False)

    def test_term_addition(self) -> None:
        self.assertEqual(interpret_expression("3+2"), D("5"))

    def test_term_subtraction(self) -> None:
        self.assertEqual(interpret_expression("3-2"), D("1"))

    def test_factor_multiplication(self) -> None:
        self.assertEqual(interpret_expression("3*2"), D("6"))

    def test_factor_division(self) -> None:
        self.assertEqual(interpret_expression("3/2"), D("1.5"))
    ...
    def test_power(self) -> None:
        self.assertEqual(interpret_expression("3**2"), D("9"))

    def test_unary_plus(self) -> None:
        self.assertEqual(interpret_expression("+42"), D("42"))
    ...
    def test_unary_bang(self) -> None:
        self.assertEqual(interpret_expression("!42"), False)

    def test_parenthesis(self) -> None:
        self.assertEqual(interpret_expression("(7+108)"), D("115"))

    def test_precedence(self) -> None:
        self.assertEqual(interpret_expression("7+108*9"), D("979"))

    def test_term_associativity(self) -> None:
        self.assertEqual(interpret_expression("7+9+3"), D("19"))

    def test_factor_associativity(self) -> None:
        self.assertEqual(interpret_expression("7*9*3"), D("189"))

    def test_power_associativity(self) -> None:
        self.assertEqual(interpret_expression("4**3**2"), D("262144"))

    def test_unary_associativity_even(self) -> None:
        self.assertEqual(interpret_expression("--3"), D("3"))
...
class TestInterpreterComplexExpressions(unittest.TestCase):
    def test_operator_precedence(self) -> None:
        self.assertAlmostEqual(
            interpret_expression("1+20*2*((3+1)*4+12)/3"),
            D("374.3333333"),
        )
